...
class Anonymisation(models.Model):
    ...
    first_sum = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    second_sum = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    third_sum = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    fourth_sum = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    fifth_sum = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
...
class Statistics(models.Model):
    ...
    first_average = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    second_average = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    third_average = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    fourth_average = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))
    fifth_average = models.DecimalField(max_digits=24, decimal_places=2, default=Decimal(0))

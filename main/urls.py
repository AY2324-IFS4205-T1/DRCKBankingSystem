...
from anonymisation.views import (CalculateAnonView, GetAnonDataView, QueryAnonView, KValueView, ViewAnonStatsView)
...
urlpatterns = [
    ...
    path("staff/set_k", KValueView.as_view(), name="set_k"),

...
def first_query_wrapper(k):
    try:
        ...
        anon_withdrawal_data, eval_result = anonymise(formatted_str_withdrawals, k, withdrawal_retriever.type)
        ...
        # TODO: Figure out what to do with this nonsense
...
def user_inputs(k, query):
    ...
    if new_input.query == "1": # Average withdrawal amount of Singaporeans for the past 5 years
        result = first_query_wrapper(new_input.k_value)
        return result    
    # TODO: Second query
    else:
